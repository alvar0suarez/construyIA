...
export const CATALOGO: TipoEstanciaDef[] = [
  ...
  // Porche: coeficiente genérico 0,5. Cada normativa puede sobreescribirlo
  // en `computo.edificabilidad.porche` (Galapagar usa 0,6 por su regla de
  // espacios cubiertos cerrados por 1-2 lados).
